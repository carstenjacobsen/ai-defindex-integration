...
import { toSmallestUnit } from "@/lib/constants";
          ...
          <>
                ...
                <div key={asset.address}>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="0.00"
                      disabled={isLoading}
                      className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-600 focus:outline-none focus:border-emerald-500/50 focus:bg-white/8 transition-all disabled:opacity-50"
                    />
                  ...
                  {asset.strategies.length > 0 && (
                    <p className="text-xs text-gray-600 mt-1">
                      Strategy: {asset.strategies.map((s) => s.name).join(", ")}
                    </p>
                  )}
                </div>
              ))}
            ...
            <div className="mb-4 p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20">
              <p className="text-xs text-emerald-400">
                You will receive dfTokens representing your share of the vault. Assets are
